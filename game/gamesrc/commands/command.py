...
class CmdEditChapter(Command):
  """
    Edit a chapter object, which means editing either the basic
    attributes of the chapter, or editing the content.

    Usage: 
      edit <chapter name> add
      edit <chapter name> 
